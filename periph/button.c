...
#define BUTTON_RIGHT_GROUP GPIOD
...
int ButtonUp()
{
	return BUTTON_NEGATE GPIO_ReadInputDataBit(BUTTON_UP_GROUP, BUTTON_UP_PIN);
}

int ButtonDown()
{
	return BUTTON_NEGATE GPIO_ReadInputDataBit(BUTTON_DOWN_GROUP, BUTTON_DOWN_PIN);
}

int ButtonLeft()
{
	return BUTTON_NEGATE GPIO_ReadInputDataBit(BUTTON_LEFT_GROUP, BUTTON_LEFT_PIN);
}

int ButtonRight()
{
	return BUTTON_NEGATE GPIO_ReadInputDataBit(BUTTON_RIGHT_GROUP, BUTTON_RIGHT_PIN);
}

int ButtonOk()
{
	return BUTTON_NEGATE GPIO_ReadInputDataBit(BUTTON_OK_GROUP, BUTTON_OK_PIN);
}
